...
function ChangeMobility() {
    ...
    if (mobility === "walking") {
        buttons = (
            <View style={styles.buttonContainer}>
                <Button title="Public Transport" onPress={() => NearByAPI(location, "5000")} />
        ...
        buttons = (
            <View style={styles.buttonContainer}>
                <Button title="Walking" onPress={() => console.log("Public Transport button pressed")} />
                <Button title="Car" onPress={() => console.log("Car button pressed")} />
            </View>
        );
    }
        ...
        buttons = (
            <View style={styles.buttonContainer}>
                <Button title="Public Transport" onPress={() => console.log("Public Transport button pressed")} />
                <Button title="Walking" onPress={() => console.log("Car button pressed")} />
            </View>
        );
    }
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.currentMobilityText}>Your current mobility is: {mobility}</Text>
